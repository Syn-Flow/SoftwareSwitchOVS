 ...
 * of OpenFlow to another. */
    ...
    /* OFPT 1.0+ (66): struct ofx_flow_mod, struct ofp11_instruction[]. */
    OFPRAW_OFPT_OFX_FLOW_MOD,

    /* OFPT 1.1+ (67): struct ofp11_packet_out, uint8_t[]. */
    OFPRAW_OFPT11_OFX_PACKET_OUT,
...
enum ofptype {
    ...
    OFPTYPE_OFX_FLOW_MOD,               /* OFPRAW_OFPT_OFX_FLOW_MOD. */
    OFPTYPE_OFX_PACKET_OUT,             /* OFPRAW_OFPT11_OFX_PACKET_OUT. */
};
