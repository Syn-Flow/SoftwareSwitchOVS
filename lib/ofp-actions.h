...
#define OFPACTS                                                     \
    ...
    DEFINE_OFPACT(OFX_PUSH_HEADER,   ofpact_ofx_push_header, action_pointer)    \
    DEFINE_OFPACT(OFX_POP_HEADER,    ofpact_null,  ofpact)    \
    DEFINE_OFPACT(OFX_PUSH_AP,     ofpact_ofx_push_ap,   ofpact)    \
    DEFINE_OFPACT(OFX_POP_AP,      ofpact_null,    ofpact)    \
    DEFINE_OFPACT(OFX_SET_TTL,     ofpact_ofx_set_ttl,   ofpact)    \
    DEFINE_OFPACT(OFX_DEC_TTL,     ofpact_null,   ofpact)    \
    DEFINE_OFPACT(OFX_JUMP,        ofpact_ofx_jump,      ofpact)    \
                                                                    \
    /* Metadata. */                                                 \
...
/* OFPACT_STRIP_VLAN, OFPACT_POP_QUEUE, OFPACT_EXIT, OFPACT_CLEAR_ACTIONS, OFPACT_OFX_POP_HEADER, OFPACT_OFX_POP_AP, OFPACT_OFX_DEC_TTL.
 *
...
/* OFPACT_OFX_PUSH_HEADER
 *
 * Used for OFPAT11_OFX_PUSH_HEADER */
 struct ofpact_ofx_push_header {
     struct ofpact ofpact;
     uint8_t ttl;
     uint8_t action_pointer_number;
     uint8_t pad[2];
...
/* OFPACT_OFX_PUSH_AP
 *
 * Used for OFPAT11_OFX_PUSH_AP */
struct ofpact_ofx_push_ap {
    struct ofpact ofpact;
    ap_kernel action_pointer;
};
...
/* OFPACT_OFX_SET_TTL
 *
 * Used for OFPAT11_OFX_SET_TTL */
 struct ofpact_ofx_set_ttl {
     struct ofpact ofpact;
     uint8_t ttl;
 };
...
/* OFPACT_OFX_JUMP
 *
 * Used for OFPAT11_OFX_JUMP */
 struct ofpact_ofx_jump {
     struct ofpact ofpact;
     ap_kernel action_pointer;
 };
