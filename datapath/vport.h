...
enum vport_information_port_spe {
	OVS_VPORT_INFORMATION_PORT_HOST,//1 host 0 switch
	OVS_VPORT_INFORMATION_PORT_STATUS, //1 active 0 inactive
	OVS_VPORT_INFORMATION_PORT_ATTR,
	OVS_VPORT_INFORMATION_NETDEV_PORT,
};
...
//*************F3_Modify_Part_Begin***************************
int ovs_vport_parse_information(const struct vport_parms *parms);
//**************F3_Modify_Part_End****************************
#endif /* vport.h */
